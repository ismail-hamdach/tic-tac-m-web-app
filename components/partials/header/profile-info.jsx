  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56 p-0" align="end">
        ...
        <DropdownMenuItem onSelect={() => signOut()} className="flex items-center gap-2 text-sm font-medium text-default-600 capitalize my-1 px-3 dark:hover:bg-background cursor-pointer">
